 ...
 */
contract BearHunterEcosystem is Initializable, ERC721Upgradeable, ERC721URIStorageUpgradeable, ERC721EnumerableUpgradeable, ERC721BurnableUpgradeable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable, IERC721Receiver, HunterStorage {
    // Custom errors
    ...
    uint256 public ownerRewardPercentage;    // 50% to hunter owner
    uint256 public burnPercentage;           // 25% burned
    uint256 public liquidityPercentage;      // 25% to liquidity
    ...
    function initialize(
        ...
        ownerRewardPercentage = 5000;    // 50% to hunter owner
        burnPercentage = 2500;           // 25% burned
        liquidityPercentage = 2500;      // 25% to liquidity
    ...
    function tokenURI(uint256 tokenId) public view override(ERC721Upgradeable, ERC721URIStorageUpgradeable) returns (string memory) {
        ...
        string memory svg = TokenURILogic.generateHunterSVG(position, tokenId, block.timestamp, RECOVERY_PERIOD);
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked(
            ...
            '"attributes":[',
            '{"trait_type":"Power","value":', Strings.toString(uint256(position.power)), '},',
            ...
            '{"trait_type":"Total Hunted","value":', Strings.toString(uint256(position.totalHunted)), '},',
