 ...
 */
contract PixelCatsFullOnChainV2 is Initializable, ERC721Upgradeable, ERC2981Upgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    uint256 public mintPrice; // Default price, can be updated
    ...
    function initialize(address _renderer, address initialOwner) public initializer {
        __ERC721_init("BTB CAT", "BTBC");
        __ERC2981_init();
        ...
        _tokenIdCounter = 1; // Start from 1, not 0

        // Set 5% royalty fee to initial owner
